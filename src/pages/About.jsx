const About = () => {
  return (
    <section id="about" className="min-h-screen py-20 px-4 md:px-16">
      <div className="text-center mb-16">
        <h3 className="text-[#ff9999] text-xl md:text-2xl mb-4">Know About Me</h3>
        <h2 className="text-white text-4xl md:text-5xl font-bold underline">About Myself</h2>
      </div>
      ...
      <div className="flex flex-col md:flex-row gap-8 md:gap-16 items-center">
        ...
        <div className="w-full md:w-1/2">
          <h3 className="text-[#ff9999] text-xl md:text-2xl mb-6">Hi I'm Danish Ansari</h3>
          ...
          <div className="mt-8">
            <h4 className="text-[#ff9999] text-lg md:text-xl mb-4">Get To Know More</h4>
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 md:gap-6">
              <div className="bg-[#1e1e1e] p-4 md:p-6 rounded-lg">
