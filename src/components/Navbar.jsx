  ...
  return (
    <header className="fixed top-0 w-full backdrop-blur-md bg-black/10 border-b border-gray-700 border-opacity-20 z-50">
      <nav className="max-w-8xl mx-auto py-6 px-6 lg:px-32 flex items-center justify-between text-white">
        <aza
          href="#about"
          className="text-xl md:text-2xl font-semibold bg-gradient-to-r from-neutral-600 via-sky-500 to-neutral-500 text-transparent bg-clip-text hover:scale-110 transition-all duration-300"
        >
          Danish Ansari
        </aza>
        <ul className="hidden text-slate-600 md:flex gap-10 text-sm md:text-base font-medium">
