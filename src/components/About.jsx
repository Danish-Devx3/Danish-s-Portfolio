      ...
      >
        ...
        >
            ...
            <div className="flex gap-10 mt-3 items-center">
                ...
                <button className="flex items-center border-2 border-black py-1 px-2 rounded-lg text-xl font-normal ">{} Resume</button>
            </div>
        </motion.div>
